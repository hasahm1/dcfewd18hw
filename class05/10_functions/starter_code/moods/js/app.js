...
// if the user inputs sleepy/lazy/tired/napping
	if(moodvalue == 'sleepy' || moodvalue == 'lazy' || moodvalue == 'tired' || moodvalue == 'napping')
    	$('body').attr("class", "sleepy");
    	$('.moodring div').removeClass("happy" || "good")
}
